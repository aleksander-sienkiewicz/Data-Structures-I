...
class Sorted_List:
    ...
    def _is_valid_index(self, i):
        ...
        """
        # Your code here
        is_valid = -len(self._values)<=i<len(self._values)
        return is_valid
    ...
    def clean(self):
        ...
        # Your code here
        #stolen from my List_array file
    ...
    def split_key(self, key):
        ...
        Parameters:
            key - a key value (?)
        Returns:
            target1 - a new Sorted List with values < key (Sorted_List_linked)
            target2 - a new Sorted List with values >= key (Sorted_List_linked)
        -------------------------------------------------------
        """
        # Your code here
        target1 = Sorted_List()
