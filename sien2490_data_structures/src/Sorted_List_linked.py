...
class Sorted_List:
    ...
    def count(self, key):
        ...
        # your code here
        number = 0
        _, cur, _ = self._linear_search(key)
        while cur != None and cur._value == key:
            number += 1
            cur = cur._next
        return(number)
    ...
    def clean(self):
        ...
        while current != None:
            _, cur, _ = self._linear_search(current._value)
            if cur != current:
                previous._next = current._next
                self._count -= 1
    ...
    def intersection(self, source1, source2):
        ...
        while source1_node is not None:
            ...
            _, cur, _ = source2._linear_search(value)
#
            if cur is not None:
                # Value is in both
                _, cur, _ = self._linear_search(value)
