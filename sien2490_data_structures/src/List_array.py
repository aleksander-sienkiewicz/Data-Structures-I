...
class List:
    ...
    def _linear_search(self, key):
        ...
        ind = 0
        cont = True
        while ind < len(self._values) and cont:
            if self._values[ind] == key:
                cont = False
                i = ind
            ind += 1
        return(i)
    ...
    def _swap(self, i, j):
        ...
        #index2 variable is just a placeholder for the swap to hold value of i
        index2 = self._values[i]
        self._values[i]=self._values[j]
        self._values[j]=index2
    ...
    def clean(self):
        ...
        """
        # Your code here
        i=0 #using i as counter to proceed through lsit
        while i< len(self._values):
            if self._values[i] in self._values[:i]:
                ...
                i+=1
                #by adding 1 only if it appears once it will repeat first step until
                #there is only one of that value left
    ...
    def combine(self, source1, source2):
        ...
        while len(source1._values) > 0 or len(source2._values) > 0:
            if (len(source1._values) > 0):
                val1 = source1._values.pop(0)
                self._values.append(val1)
            if (len(source2._values) > 0):
                val2 = source2._values.pop(0)
    ...
    def remove_many(self, key):
        ...
        while count< len(self._values):
            ...
            else:#add only in else because if you do end up removing
                #an item the sequencial index will be 0 
                count+=1
