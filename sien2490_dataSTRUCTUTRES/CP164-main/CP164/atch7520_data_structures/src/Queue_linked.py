...
class Queue:
    ...
    def _move_front(self, source):
        ...
        nextbutt = source._rear._next
        
        source._rear = self.remove()
        source._rear._next = nextbutt
    ...
    def _append_queue(self, source):
        ...
        curr = self._rear
        sourcecurr = source._front
        for _x in range(len(source)):
            curr._next = sourcecurr
            sourcecurr = sourcecurr._next
    ...
    def combine(self, source1, source2):
        ...
        curr = self._front
        s1Curr = source1._front._next
        s2Curr = source2._front
        for _x in range(len(source1)):
            curr._next = s1Curr
            curr = curr._next
            s1Curr = s1Curr._next
        for _y in range(len(source1)):
            curr._next = s2Curr
            curr = curr._next
            s1Curr = s2Curr._next
